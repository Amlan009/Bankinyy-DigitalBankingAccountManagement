...
public void selfTransfer(String username, Long sourceAccountId, Long destinationAccountId, BigDecimal amount, String providedPin) {
    ...
    @Transactional(readOnly = true)
    public java.util.Map<String, String> verifyRecipient(String accountNumber) {
        Account account = accountRepository.findByAccountNumber(accountNumber)
                .orElseThrow(() -> new RuntimeException("Recipient account number not found."));
        String bankName = account.getBank() != null ? account.getBank().getName() : "";
        return java.util.Map.of(
                "holderName", account.getUser().getFullName(),
                "bankName", bankName
        );
    }
    ...
    public List<AccountDto> getAccountsForUser(String username) {
        List<Account> accounts = accountRepository.findByUser_UsernameOrderByBank_NameAsc(username);
